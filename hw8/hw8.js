/*--------------------------------------------------------------------------------
modified from 18_SmoothShading.js
----------------------------------------------------------------------------------*/
...
let lightingModel = 'PHONG';        // 'PHONG' or 'GOURAUD'
...
function setupKeyboardEvents() {
    document.addEventListener('keydown', (event) => {
        if (event.key == 'a') {
            ...
            cone.updateNormals();
            shadingMode = 'SMOOTH';
            updateText(textOverlay3, "shading mode: " + shadingMode + " (" + lightingModel + ")");
            render();
        }
        else if (event.key == 'f') {
...
async function main() {
    try {
        ...
        shaderPhong.setFloat("material.shininess", 16);
        ...
        shaderGouraud.setFloat("material.shininess", 16);
        ...
        setupText(canvas, "prees 'g' to switch to Gouraud shading", 8);
