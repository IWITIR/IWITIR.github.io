/*-------------------------------------------------------------------------
modified from 10_CameraCircle.js
---------------------------------------------------------------------------*/
...
function render() {
    ...
    let camY = cameraCircleHeight * Math.sin(glMatrix.toRadian(cameraYSpeed * elapsedTime)) + cameraCircleHeight; // oscillate [0, 2*cameraCircleHeight]
